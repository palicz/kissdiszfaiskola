...
export const ImageMedia: React.FC<MediaProps> = (props) => {
  ...
  const mergedStyle =
    objectPositionFromFocal || fitStyle
      ? {
          ...(objectPositionFromFocal ? { objectPosition: objectPositionFromFocal } : {}),
          ...fitStyle,
        }
      : undefined

  // String URL only (no Payload `resource`)
  if (typeof src === 'string' && src && !src.startsWith('http://') && !src.startsWith('https://')) {
    src = getMediaUrl(src)
  }
