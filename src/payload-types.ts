...
export interface Page {
  ...
  title: string;
  hero: {
    type: 'none' | 'kissHome' | 'highImpact' | 'mediumImpact' | 'lowImpact';
    /**
     * Pl. „ESTABLISHED 1994 • NAGYKÁLLÓ”.
     */
    eyebrow?: string | null;
    /**
     * Egy sorban marad (pl. „Üdvözöljük a”).
     */
    ...
    /**
     * Átlapolódó kép mobilnézetben.
     */
    overlapImage?: (number | null) | Media;
    specimenLabel?: string | null;
    specimenSublabel?: string | null;
    richText?: {
      root: {
        type: string;
        children: {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "KissSpecimenBlock".
 */
export interface KissSpecimenBlock {
  eyebrow?: string | null;
  titleLine1: string;
  titleLine2?: string | null;
  /**
   * Opcionális link a katalógushoz vagy galériához.
   */
  listLink: {
    type?: ('reference' | 'custom') | null;
    newTab?: boolean | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "KissVisitBlock".
 */
export interface KissVisitBlock {
  /**
   * Pl. „Látogasson el hozzánk”.
   */
  title: string;
  image?: (number | null) | Media;
  /**
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "KissOurStoryBlock".
 */
export interface KissOurStoryBlock {
  /**
   * Pl. „Történetünk”.
   */
  heading: string;
  ...
  body: string;
  /**
   * Dőlt, kiemelt szöveg a választóvonal alatt.
   */
  closingStatement?: string | null;
  /**
   * Pl. „Mónika és Csaba” (a kötőjel a megjelenítésben hozzáadódik).
   */
  signature?: string | null;
  /**
   * Pl. „Hagyomány”, „Minőség”.
   */
  tags?:
    | {
        label: string;
  ...
  id?: string | null;
  blockName?: string | null;
  blockType: 'kissOurStory';
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "KissPlantCatalogBlock".
 */
export interface KissPlantCatalogBlock {
  title: string;
  /**
   * Pl. Botanikai gyűjtemény (opcionális).
   */
  eyebrow?: string | null;
  /**
   * Mobilon gyakran magas (álló), asztalon opcionális.
   */
  introImage?: (number | null) | Media;
  introBody?: string | null;
  /**
   * Halvány háttér + bal szegéllyel jelenik meg a bevezető alatt.
   */
  ...
  sections?:
    | {
        ...
        title: string;
        /**
         * Pl. ÁRLISTÁNK VÁLASZTÉKA vagy angol rövid címke.
         */
        eyebrow?: string | null;
        description?: string | null;
        image?: (number | null) | Media;
        ...
        desktopLayout?: ('textLeftImageRight' | 'imageLeftTextRight' | 'stacked') | null;
        /**
        ...
        groups?:
          | {
              /**
               * Pl. Lombhullatók. Hagyja üresen, ha egyetlen lista kell.
               */
              heading?: string | null;
              intro?: string | null;
              /**
  ...
  id?: string | null;
  blockName?: string | null;
  blockType: 'kissPlantCatalog';
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "KissGalleryBlock".
 */
export interface KissGalleryBlock {
  title: string;
  /**
  ...
  intro?: string | null;
  /**
   * Minden elemhez egy kép (media) és a kép alá kerülő felirat kötelező.
   */
  items?:
    | {
        image: number | Media;
        /**
         * Pl. növényfaj név — a kép alatt, középen.
         */
        caption: string;
        id?: string | null;
      }[]
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "KissNewsletterBlock".
 */
export interface KissNewsletterBlock {
  title: string;
  description: string;
  emailPlaceholder?: string | null;
  buttonLabel?: string | null;
  /**
   * Rövid tájékoztató: adatkezelés, leiratkozás. Üresen hagyható.
   */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "KissSpecimenBlock_select".
 */
export interface KissSpecimenBlockSelect<T extends boolean = true> {
  eyebrow?: T;
  titleLine1?: T;
  titleLine2?: T;
  listLink?:
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "KissVisitBlock_select".
 */
export interface KissVisitBlockSelect<T extends boolean = true> {
  title?: T;
  image?: T;
  statNumber?: T;
  statLabel?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "KissOurStoryBlock_select".
 */
export interface KissOurStoryBlockSelect<T extends boolean = true> {
  heading?: T;
  image?: T;
  body?: T;
  closingStatement?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "KissPlantCatalogBlock_select".
 */
export interface KissPlantCatalogBlockSelect<T extends boolean = true> {
  title?: T;
  eyebrow?: T;
  introImage?: T;
  introBody?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "KissGalleryBlock_select".
 */
export interface KissGalleryBlockSelect<T extends boolean = true> {
  title?: T;
  intro?: T;
  items?:
    | T
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "KissNewsletterBlock_select".
 */
export interface KissNewsletterBlockSelect<T extends boolean = true> {
  title?: T;
  description?: T;
  emailPlaceholder?: T;
  buttonLabel?: T;
...
export interface Footer {
  id: number;
  /**
   * Rövid szöveg a lábrész első oszlopában.
   */
