...
/**
 * Drops image-optimizer columns and table added by the reverted plugin migration.
 * PostgreSQL enum values on `enum_payload_jobs_task_slug` are not removed (Postgres limitation).
 */
